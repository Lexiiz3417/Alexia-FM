...
export default {
    ...
    async execute(interaction) {
        ...
        try {
            ...
            // 3. Logika Pengambilan Data Otomatis
            if (songUrl) {
                ...
                if (odesliData) {
                    ...
                    if (!customTitle && !customArtist && !customImage) {
                        ...
                        if (hdInfo) {
                            ...
                            // FALLBACK: Deezer Gagal, Bersihin Manual & Suntik HD!
            ...
            // 🌟 4. SKENARIO B: Input Manual (Wajib Lewat Bea Cukai Metadata)
            if (customTitle || customArtist) {
                const manualClean = cleanMetadata(customTitle || finalTitle, customArtist || finalArtist);
                finalTitle = manualClean.cleanTitle;
                finalArtist = manualClean.cleanArtist;
            }
            ...
            // 5. Generate Kartu (Panggil ImageProcessor 2K)
            const songObj = {
                title: finalTitle,
                artist: finalArtist,
